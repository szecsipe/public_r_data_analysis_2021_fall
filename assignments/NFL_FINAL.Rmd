...
MVP
```
The plot shows us that it does not mean the same to be the best in every team. You can even see that Peyton Manning managed to be the highest rated players of two teams (Denver and Indianapolis). Standard deviations of ratings were not added to the plot (a plot it below), they show that it is possible that these players do not differ based on their ratings.
